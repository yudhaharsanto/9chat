          ...
          <div className="space-y-5">
            ...
            <div className="rounded-xl border bg-card p-4 space-y-3">
              ...
              {limit != null && (
                <div className="w-full h-2 rounded-full bg-muted overflow-hidden">
                  <div
                    className={`h-full ${usagePercent && usagePercent > 90 ? "bg-destructive" : usagePercent && usagePercent > 70 ? "bg-amber-500" : "bg-primary"}`}
            ...
            {modelEntries.length > 0 && (
              <div className="rounded-xl border bg-card p-4 space-y-3">
                ...
                <p className="text-[10px] text-muted-foreground pt-1 border-t">Persentase dari total keseluruhan token</p>
              </div>
            )}
